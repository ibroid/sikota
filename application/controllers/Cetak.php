	...
	public function relaas_panggilan_sidang(array $data)
	{
		$export =  array_merge(
			...
			[
				...
				'nama_pihak' => $data['pihak'],
				'nama_pe' => ($data['para_pihak']) ? sippTable()::paraPihak($data['para_pihak'])[1] : $data['pihak'],
				'nama_te_1' => ($data['para_pihak']) ? sippTable()::paraPihak($data['para_pihak'])[3] : 'Tergugat',
				'jenis_pihak_pe' => ($data['para_pihak']) ? sippTable()::paraPihak($data['para_pihak'])[0] : 'Penggugat' ,
				'jenis_pihak_te' => ($data['para_pihak']) ? sippTable()::paraPihak($data['para_pihak'])[2] : 'Tergugat',
				'jenis_pihak' => $data['status_pihak'],
				'nomor_perkara' => $data['nomor_perkara'],
				'alamat_pihak' => $data['alamat_pihak']
			]
