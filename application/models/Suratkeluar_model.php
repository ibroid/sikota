...
class Suratkeluar_model extends CI_Model {
	...
	var $column_order = array(null, 'tujuan','no_surat','jenis_surat','perihal','isi','tgl_surat','tgl_catat','keterangan'); //set column field database for datatable orderable
	var $column_search = array('tujuan','no_surat','jenis_surat','perihal','isi','tgl_surat','tgl_catat','keterangan'); //set column field database for datatable searchable 
