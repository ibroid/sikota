...
<body data-spy="scroll" data-target=".fixed-top">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>Hingga Saat Ini, Tercatat Sebanyak $total_delegasi_keluar Bantuan Delegasi Dari $nama_satker ke Pengadilan Agama Lain</p>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>Hingga Saat Ini, Tercatat Sebanyak $total_delegasi_masuk Bantuan Delegasi Ke $nama_satker Dari Pengadilan Agama Lain</p>
                        </div>
                    </div>
                    <!-- end of card -->
    ...
    <div id="pricing" class="cards-2">
    	<div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h2>List Radius $nama_satker</h2>
                    <p class="p-heading p-large">Berkenaan Dengan Biaya Panggilan Di $nama_satker, Berikut Adalah Tabel Radius Secara Lengkap </p>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-12">	  
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <p class="p-heading p-large">Team Delegasi $nama_satker </p>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="team-member">
                        ...
                        <p class="job-title">Kordel Dari $nama_satker Ke PA Lain</p>
                    ...
                    <div class="team-member">
                        ...
                        <p class="p-large"><strong>Jejen Nursalim, A.Md</strong></p>
                        <p class="job-title">Kordel Dari PA Lain Ke $nama_Satker</p>
                        <span class="social-icons">
                            <span class="fa-stack">
                                <a href="#your-link">
                                    <i class="fas fa-circle fa-stack-2x facebook"></i>
                    ...
                    <div class="team-member">
                        <div class="image-wrapper">
                            <img class="img-fluid" src="<?php echo base_url('assets/halaman_publik/web/images/team-member-4.svg') ?>" alt="alternative">
                        </div> <!-- end of image wrapper -->
                        <p class="p-large"><strong>Lizna Sofra, ST</strong></p>
                        <p class="job-title">Operator Surat Umum</p>
                        <span class="social-icons">
                            <span class="fa-stack">
                                <a href="#your-link">
                                    <i class="fas fa-circle fa-stack-2x facebook"></i>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="list-unstyled li-space-lg">
                        <li class="address">Pengelola Surat Dan Delegasi $nama_satker</li>
